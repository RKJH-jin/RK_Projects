...
TeacherAI::TeacherAI()
{
	...
	//컨디션
	_isPlace = new StrCondition(bind(&TeacherAI::IsTileObject, this, std::placeholders::_1), "교실");
	_isReached = new StrCondition(bind(&TeacherAI::IsReached, this, std::placeholders::_1), "교실");
...
HRESULT TeacherAI::init(Character * character)
{
...
void TeacherAI::Update()
{
	_root->invoke();
}

bool TeacherAI::IsTileObject(string name)
{
...
bool TeacherAI::IsReached(string name)
{
